...
- `infection_study_04`: 43,767 cells, 26,361 original processed genes, 8,000 pre-HVG genes, 3,933 analysis X/var genes, 16 submitted labels, parent/Blood residual fraction 0.012, median confidence 0.838.
...
- Overall: 43,767 cells / 26,361 original processed genes / 8,000 pre-HVG genes / 3,933 analysis X/var genes. Parent/Blood residual is 529 cells (0.012), but source disagreement is elevated at 11,680 cells (0.267).
