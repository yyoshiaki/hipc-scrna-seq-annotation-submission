...
| study | cells | genes | labels | parent_or_blood_fraction | Blood Cell | Doublet | artifact_like | median_confidence | low_confidence | invalid_labels |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| infection_study_04 | 43,767 | 3,933 | 16 | 0.012 | 529 | 61 | 353 | 0.838 | 751 | none |
...
- Submission TSVs: `outputs/single_dataset_checks/260523_infection_study_04_master/submissions/`
- cellxgene H5ADs: `outputs/single_dataset_checks/260523_infection_study_04_master/cellxgene/`
- Marker availability table: `outputs/single_dataset_checks/260523_infection_study_04_master/tables/marker_gene_availability.tsv`
- Marker availability alerts: `outputs/single_dataset_checks/260523_infection_study_04_master/tables/marker_gene_availability_alerts.tsv`
- Subcluster evidence: `outputs/single_dataset_checks/260523_infection_study_04_master/tables/lineage_subcluster_evidence.tsv.gz`
- Diagnostics tables: `outputs/single_dataset_checks/260523_infection_study_04_master/tables/`
