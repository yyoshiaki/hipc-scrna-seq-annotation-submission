...
- `vaccination_study_09`: 139,960 cells, 19,141 original processed genes, 8,000 pre-HVG genes, 3,985 analysis X/var genes, 17 submitted labels, parent/Blood residual fraction 0.001, median confidence 0.838.
...
- Overall: 139,960 cells / 19,141 original processed genes / 8,000 pre-HVG genes / 3,985 analysis X/var genes. This is the largest dataset. Parent/Blood residual is very low at 120 cells (0.001), and median confidence is good at 0.838, although source disagreement remains non-trivial at 29,879 cells (0.213).
