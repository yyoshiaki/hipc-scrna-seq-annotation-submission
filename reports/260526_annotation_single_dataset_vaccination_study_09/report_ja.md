...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| vaccination_study_09 | 139,960 | 3,985 | 17 | 0.001 | 120 | 323 | 104 | 0.838 | 443 | 29,879 (0.213) | none |
...
- `vaccination_study_09`: 139,960 cells、3,985 genes、submitted label 17 種、parent/Blood residual fraction 0.001、median confidence 0.838。
...
- 全体像: 139,960 cells / 3,985 genes。最大 dataset で、parent/Blood residual は 120 cells (0.001) と非常に低いです。median confidence は 0.838 で良好ですが、source disagreement は 29,879 cells (0.213) と無視できません。
