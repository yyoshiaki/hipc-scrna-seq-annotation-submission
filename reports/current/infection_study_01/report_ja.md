...
現在の annotation は意図的に conservative にしています。主要な PBMC lineage は概ね分かれていますが、T lineage に parent label が残っており、CD4/T subtype は cellxgene 上で確認してから final-final と扱うべきです。
...
- この dataset の主な確認対象: 現在の annotation は意図的に conservative にしています。主要な PBMC lineage は概ね分かれていますが、T lineage に parent label が残っており、CD4/T subtype は cellxgene 上で確認してから final-final と扱うべきです。
