...
Major PBMC structure is visible, but the current call set remains intentionally conservative in T-lineage clusters. Generic T Cell residuals are concentrated enough to require marker/source review rather than blind forced refinement.
