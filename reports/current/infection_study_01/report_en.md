...
| Selected source | `outputs/submission_final_v22/infection_study_01/submissions/infection_study_01_annotation.tsv` |
| Cells | 54,924 |
| Number of labels | 16 |
| Parent/Blood residual | 178 cells (0.0032) |
| Median confidence | 0.7772 |
| Top labels | Classical Monocyte: 17,789; CD8 Cytotoxic / T Effector Memory: 10,509; NK Cell: 8,060; CD4 T Effector Memory: 4,387; Naive B Cell: 4,269; CD4 Naive / T Central Memory: 2,341; Memory B Cell: 2,100; Non-Classical Monocyte: 1,979 |
| Current assessment | Relatively good candidate submission. Parent/Blood residual is low; review should focus on per-dataset UMAP and marker evidence. |
