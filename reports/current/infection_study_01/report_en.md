...
- `infection_study_01`: 54,924 cells, 33,538 analysis X/var genes, 33,538 pre-HVG slot genes, 19 submitted labels, parent/Blood residual fraction 0.006, median confidence 0.850.
  - 3,691 cells have low confidence and should be inspected on QC/confidence UMAPs.
...
- Overall: 54,924 cells / 33,538 analysis X/var genes / 33,538 pre-HVG slot genes. Parent/Blood residual fraction is 0.006; low-confidence cells are 3,691; source-disagreement flags affect 7,485 cells (0.136).
