...
| Selected source | `outputs/submission_final_v22/vaccination_study_09/submissions/vaccination_study_09_annotation.tsv` |
| Cells | 139,960 |
| Number of labels | 18 |
| Parent/Blood residual | 155 cells (0.0011) |
| Median confidence | 0.7772 |
| Top labels | CD4 Naive / T Central Memory: 54,333; Classical Monocyte: 26,795; CD8 Cytotoxic / T Effector Memory: 13,647; Naive B Cell: 12,334; NK Cell: 9,187; CD8 Naive / T Central Memory: 7,394; MAIT Cell: 5,153; Non-Classical Monocyte: 3,949 |
| Current assessment | Relatively good candidate submission. Review T-subset granularity and gamma-delta / MAIT / NKT handling with per-dataset UMAP and marker evidence. |
