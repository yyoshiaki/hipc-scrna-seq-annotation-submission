...
- `vaccination_study_06`: 57,419 cells, 11,878 analysis X/var genes, 11,878 pre-HVG slot genes, 11 submitted labels, parent/Blood residual fraction 0.027, median confidence 0.702.
  - 7,611 cells have low confidence and should be inspected on QC/confidence UMAPs.
...
- Overall: 57,419 cells / 11,878 analysis X/var genes / 11,878 pre-HVG slot genes. Parent/Blood residual fraction is 0.027; low-confidence cells are 7,611; source-disagreement flags affect 16,358 cells (0.285).
