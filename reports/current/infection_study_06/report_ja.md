...
- TSV: `submission_package_emergency_260612.zip` 内の `submissions/infection_study_06_annotation.tsv`
- このdatasetで使ったsource package: `current_clean` (current_clean fallback)
- 行数: 827,389
- template行数: 827,389
- barcode順序がtemplateと一致: `True`
- 提出label数: 4
- confidence中央値: 0.4500
- low-confidence cell数: 827,389

## Validation

- 列名OK: `True`
- invalid ontology label数: 0
- confidence範囲: 0.3748 to 0.5185
...
| --- | --- | --- |
| T Cell | 278393 | 0.336 |
| Blood Cell | 235997 | 0.285 |
| Myeloid Cell | 223092 | 0.270 |
| B Cell | 89907 | 0.109 |
