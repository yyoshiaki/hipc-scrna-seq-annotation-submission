...
| Selected source | `outputs/submission_v23_marker_rescue_scavenge/infection_study_06/submissions/infection_study_06_annotation.tsv` |
| Cells | 827,389 |
| Number of labels | 9 |
| Parent/Blood residual | 681,258 cells (0.8234) |
| Median confidence | 0.4500 |
| Top labels | Blood Cell: 235,558; Myeloid Cell: 197,279; T Cell: 174,692; NKT Cell: 83,080; B Cell: 73,729; Classical Monocyte: 21,846; CD8 Naive / T Central Memory: 19,442; Naive B Cell: 18,040 |
| Current assessment | Included as a candidate submission, but low confidence. Broad parent labels remain high and NKT may be inflated; reclustering after sample_id-aware batch correction is needed. |
