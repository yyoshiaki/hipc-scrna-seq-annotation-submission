...
現在のセットの中では parent label が最も少なく、balanced whole PBMC というより myeloid/DC 寄りに見えます。pDC/DC は単一遺伝子ではなく複数 marker の支持で判断する必要があります。
...
- この dataset の主な確認対象: 現在のセットの中では parent label が最も少なく、balanced whole PBMC というより myeloid/DC 寄りに見えます。pDC/DC は単一遺伝子ではなく複数 marker の支持で判断する必要があります。
