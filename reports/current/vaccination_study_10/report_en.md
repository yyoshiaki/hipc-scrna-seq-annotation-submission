...
| Selected source | `outputs/submission_v24_safe_rescue_scavenge/vaccination_study_10/submissions/vaccination_study_10_annotation.tsv` |
| Cells | 47,511 |
| Number of labels | 4 |
| Parent/Blood residual | 47,511 cells (1.0000) |
| Median confidence | 0.4500 |
| Top labels | Blood Cell: 17,560; T Cell: 14,514; Myeloid Cell: 9,534; B Cell: 5,903 |
| Current assessment | v24 safe fallback. Fine annotation is currently unreliable because the available input is a 1271-gene transformed matrix, so the current output intentionally stays at conservative broad labels. Raw / all-gene input should be rechecked. |
