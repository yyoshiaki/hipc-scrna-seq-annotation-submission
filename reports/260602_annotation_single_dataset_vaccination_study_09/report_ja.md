...
vaccination_study_09 は 139,960 cells / 19,141 portal genes の dataset です。親ラベルまたは Blood Cell に残った割合は 0.3%、doublet は 579 cells、低 confidence は 1,037 cells でした。注意すべき marker gene 欠損は Plasma_ASC(warning: JCHAIN) です。 大規模な T/B dataset で、screfmap は B/CD4T の補助として広く利用できます。 subcluster evidence では CD4 Naive / T Central Memory: 64,895 cells; Classical Monocyte: 25,752 cells; Naive B Cell: 11,614 cells; CD8 Cytotoxic / T Effector Memory: 10,513 cells; NK Cell: 10,322 cells; Non-Classical Monocyte: 4,365 cells が主要な構造です。全細胞に近い coverage で最も broad lineage に沿った source は Marker score (broad concordance 98.0%) で、相対的に不一致が目立つ source は Azimuth PBMC L3 (36.3%) です。 screfmap は適用範囲を B/CD4T に限定すると coverage 40.0%、broad concordance 98.9% でした。 v14 marker registry audit は、marker gene list をそのまま全細胞で競わせるのではなく、broad lineage、applicable lineage、key-marker support の順に制限した場合に marker evidence がどう変わるかを見る診断です。単純 winner では Eosinophil 101,081 cells、Platelet 166 cells のような rare/artifact label が出やすい一方、gate 後は Eosinophil 40 cells、Platelet 87 cells に抑制されます。これは final label を marker score だけで置き換えるためではなく、fine label を受け入れる条件と confidence cap を決めるための evidence audit です。 最も gate 後の未割当が多い lineage は Other_lineage (29.2%) です。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 139,960 | 19,141 | layers[counts] | 1.000 | 49 | IGHD;IGHM;JCHAIN;TRDC | 0.003 | 0.780 | 1,037 | 579 |
...
![Final labels](assets/umap_vaccination_study_09_v14_label.png)

![QC and confidence](assets/umap_vaccination_study_09_v14_qc_confidence.png)

![Lineage and annotation reason](assets/umap_vaccination_study_09_v14_lineage_reason.png)
...
| --- | --- | --- | --- | --- | --- | --- |
| CellTypist | 139,960 | 1.000 | 0.755 | 0.967 | CD4 Naive / T Central Memory: 53,998; Classical Monocyte: 23,807; NK Cell: 15,934; Naive B Cell: 6,921; CD8 Cytotoxic / T Effector Memory: 6,288 | CD4 Naive / T Central Memory vs CD8 Naive / T Central Memory: 4,549; CD8 Cytotoxic / T Effector Memory vs NK Cell: 3,931; Naive B Cell vs B Cell: 3,647; CD4 Naive / T Central Memory vs CD4 T Effector Memory: 1,922; CD4 Naive / T Central Memory vs CD8 Cytotoxic / T Effector Memory: 1,734 |
| Azimuth PBMC L2 | 139,960 | 1.000 | 0.487 | 0.807 | CD4 Naive / T Central Memory: 38,553; RBC: 25,752; Treg: 17,107; CD8 Naive / T Central Memory: 11,771; CD8 Cytotoxic / T Effector Memory: 10,091 | Classical Monocyte vs RBC: 21,007; CD4 Naive / T Central Memory vs Treg: 14,149; CD4 Naive / T Central Memory vs CD8 Naive / T Central Memory: 8,978; NK Cell vs CD8 Cytotoxic / T Effector Memory: 3,313; Naive B Cell vs Memory B Cell: 2,419 |
| Azimuth PBMC L3 | 139,960 | 1.000 | 0.158 | 0.363 | Blood Cell: 61,873; RBC: 26,415; Treg: 16,491; CD4 Naive / T Central Memory: 12,530; CD8 Naive / T Central Memory: 9,329 | CD4 Naive / T Central Memory vs Blood Cell: 27,899; Classical Monocyte vs RBC: 21,008; CD4 Naive / T Central Memory vs Treg: 13,699; Naive B Cell vs Blood Cell: 10,312; NK Cell vs Blood Cell: 8,752 |
| Pan-human Azimuth fine | 139,960 | 1.000 | 0.711 | 0.885 | CD4 Naive / T Central Memory: 47,132; Classical Monocyte: 21,039; Blood Cell: 16,227; CD8 Cytotoxic / T Effector Memory: 13,298; Naive B Cell: 9,399 | CD4 Naive / T Central Memory vs CD4 T Effector Memory: 6,920; Classical Monocyte vs Blood Cell: 4,702; CD4 Naive / T Central Memory vs Blood Cell: 3,918; CD4 Naive / T Central Memory vs CD8 Naive / T Central Memory: 3,167; NK Cell vs CD8 Cytotoxic / T Effector Memory: 2,446 |
| Pan-human Azimuth medium | 139,960 | 1.000 | 0.061 | 0.890 | T Cell: 76,051; Monocyte: 24,919; Blood Cell: 15,334; B Cell: 12,992; NK Cell: 8,184 | CD4 Naive / T Central Memory vs T Cell: 58,781; Classical Monocyte vs Monocyte: 19,024; Naive B Cell vs B Cell: 9,509; CD8 Cytotoxic / T Effector Memory vs T Cell: 8,619; Classical Monocyte vs Blood Cell: 4,698 |
| Cluster consensus | 139,960 | 1.000 | 0.742 | 0.924 | CD4 Naive / T Central Memory: 47,192; Classical Monocyte: 16,487; CD8 Cytotoxic / T Effector Memory: 14,680; CD8 Naive / T Central Memory: 11,659; Naive B Cell: 11,466 | CD4 Naive / T Central Memory vs CD8 Naive / T Central Memory: 9,597; Classical Monocyte vs Blood Cell: 8,482; CD4 Naive / T Central Memory vs CD8 Cytotoxic / T Effector Memory: 4,301; NK Cell vs CD8 Cytotoxic / T Effector Memory: 2,233; CD4 Naive / T Central Memory vs Treg: 1,305 |
| Marker score | 139,960 | 1.000 | 0.099 | 0.980 | CD4 T Cell (ab): 39,681; Monocyte: 30,898; T Cell: 28,581; B Cell: 15,827; NK Cell: 14,482 | CD4 Naive / T Central Memory vs CD4 T Cell (ab): 35,459; Classical Monocyte vs Monocyte: 23,718; CD4 Naive / T Central Memory vs T Cell: 22,713; Naive B Cell vs B Cell: 11,599; Memory B Cell vs B Cell: 3,738 |
| screfmap scoped | 56,028 | 0.400 | 0.866 | 0.989 | CD4 Naive / T Central Memory: 35,246; Naive B Cell: 10,162; Memory B Cell: 4,845; CD4 T Effector Memory: 3,623; Treg: 1,967 | CD4 Naive / T Central Memory vs CD4 T Effector Memory: 3,087; CD4 Naive / T Central Memory vs Treg: 1,394; Naive B Cell vs Memory B Cell: 1,094; CD8 Cytotoxic / T Effector Memory vs CD4 T Effector Memory: 212; Treg vs CD4 Naive / T Central Memory: 209 |
...
| --- | --- | --- | --- | --- |
| B | CellTypist | 15,544 | 0.597 | 0.978 |
| B | Azimuth PBMC L2 | 15,544 | 0.657 | 0.895 |
| B | Azimuth PBMC L3 | 15,544 | 0.010 | 0.010 |
| B | Pan-human Azimuth fine | 15,544 | 0.707 | 0.839 |
| B | Pan-human Azimuth medium | 15,544 | 0.000 | 0.832 |
| B | Cluster consensus | 15,544 | 0.933 | 0.998 |
| B | Marker score | 15,544 | 0.010 | 0.998 |
| B | screfmap scoped | 14,857 | 0.909 | 0.997 |
| T/NK | CellTypist | 90,667 | 0.763 | 0.986 |
| T/NK | Azimuth PBMC L2 | 90,667 | 0.556 | 0.990 |
| T/NK | Azimuth PBMC L3 | 90,667 | 0.174 | 0.472 |
| T/NK | Pan-human Azimuth fine | 90,667 | 0.701 | 0.918 |
| T/NK | Pan-human Azimuth medium | 90,667 | 0.089 | 0.928 |
| T/NK | Cluster consensus | 90,667 | 0.751 | 0.998 |
| T/NK | Marker score | 90,667 | 0.122 | 0.982 |
| T/NK | screfmap scoped | 40,619 | 0.862 | 1.000 |
| Myeloid/DC | CellTypist | 32,574 | 0.821 | 0.933 |
| Myeloid/DC | Azimuth PBMC L2 | 32,574 | 0.227 | 0.255 |
| Myeloid/DC | Azimuth PBMC L3 | 32,574 | 0.186 | 0.210 |
| Myeloid/DC | Pan-human Azimuth fine | 32,574 | 0.751 | 0.823 |
...
- cellxgene H5AD: `cellxgene/vaccination_study_09.final_v14_marker_gate_applied.cxg.h5ad`
