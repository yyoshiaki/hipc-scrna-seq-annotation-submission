...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| vaccination_study_04 | 66,065 | 3,971 | 11 | 0.008 | 531 | 1,249 | 111 | 0.845 | 1,782 | 4,236 (0.064) | none |
...
- `vaccination_study_04`: 66,065 cells、3,971 genes、submitted label 11 種、parent/Blood residual fraction 0.008、median confidence 0.845。
...
- 全体像: 66,065 cells / 3,971 genes。label 構成は monocyte/DC 系に強く偏り、Classical Monocyte 34,105 cells、Non-Classical Monocyte 15,314 cells、cDC2 7,694 cells、pDC 5,447 cells が主体です。whole PBMC というより myeloid/DC-enriched dataset として読むべきです。
