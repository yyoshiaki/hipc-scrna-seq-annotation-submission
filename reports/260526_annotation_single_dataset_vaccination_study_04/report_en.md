...
- `vaccination_study_04`: 66,065 cells, 3,971 genes, 11 submitted labels, parent/Blood residual fraction 0.008, median confidence 0.845.
...
- Overall: 66,065 cells / 3,971 genes. The composition is strongly monocyte/DC-enriched: Classical Monocyte 34,105 cells, Non-Classical Monocyte 15,314 cells, cDC2 7,694 cells, and pDC 5,447 cells. This should be read as a myeloid/DC-enriched dataset rather than balanced whole PBMC.
