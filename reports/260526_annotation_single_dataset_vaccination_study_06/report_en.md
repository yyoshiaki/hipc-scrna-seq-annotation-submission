...
- `vaccination_study_06`: 57,419 cells, 11,878 genes, 11 submitted labels, parent/Blood residual fraction 0.003, median confidence 0.767.
...
- Overall: 57,419 cells / 11,878 genes. Gene coverage is the highest among the tested datasets, but source disagreement is also the highest at 22,047 cells (0.384), and median confidence is lower at 0.767.
