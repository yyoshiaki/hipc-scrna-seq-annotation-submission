...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| vaccination_study_06 | 57,419 | 11,878 | 11 | 0.003 | 121 | 2,162 | 0 | 0.767 | 2,582 | 22,047 (0.384) | none |
...
- `vaccination_study_06`: 57,419 cells、11,878 genes、submitted label 11 種、parent/Blood residual fraction 0.003、median confidence 0.767。
...
- 全体像: 57,419 cells / 11,878 genes。gene coverage は最も高い一方、source disagreement は 22,047 cells (0.384) と最大で、median confidence も 0.767 と低めです。
