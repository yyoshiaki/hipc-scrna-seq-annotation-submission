...
- `infection_study_01`: 54,924 cells, 3,961 X/var genes, 8,000 raw genes, 16 submitted labels, parent/Blood residual fraction 0.004, median confidence 0.819.
...
- Overall: 54,924 cells / 3,961 X/var genes / 8,000 raw genes. Parent/Blood residual is low at 193 cells (0.004), median confidence is 0.819, and source disagreement is moderate at 7,791 cells (0.142).
