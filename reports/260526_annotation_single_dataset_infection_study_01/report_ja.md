...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| infection_study_01 | 54,924 | 3,961 | 16 | 0.004 | 193 | 981 | 1,340 | 0.819 | 2,030 | 7,791 (0.142) | none |
...
- `infection_study_01`: 54,924 cells、3,961 genes、submitted label 16 種、parent/Blood residual fraction 0.004、median confidence 0.819。
...
- 全体像: 54,924 cells / 3,961 genes。parent/Blood residual は 193 cells (0.004) と低く、median confidence は 0.819。source disagreement は 7,791 cells (0.142) で、5 dataset の中では中等度です。
